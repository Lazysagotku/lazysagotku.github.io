...
TRACKS = {
    "infra": Track("infra", "Infrastructure Engineer L2-L3",
                   ...
                   version_of="infra-v2", version_label="🔀 Версия 1 - компакт (слои 0 и 4)"),
    "infra-v2": Track("infra-v2", "Infrastructure Engineer L2-L3 - версия 1 (слои 0 и 4)",
                   "Компактные слои 0 и 4: построчный разбор команд/SQL без историй и без глубоких кейсов - самодостаточная база, сделанная до сверки с независимыми review. Остальные 8 слоёв не дублируются - ждут решения по OPEN_LOOPS #15.",
                   "roadmap-infra-v2", "Roadmap_Infra_Sept2026_v2.md", "InfraV2_Layer*.md", "Слой", "Слои", "слоёв", "🖥",
                   "закрыт", "слой", "этом слое",
                   version_of="infra", version_label="🔀 Версия 2 - полная (истории, кейсы, все 10 слоёв)"),
